...
import { getSubCategory } from "../../APIs/sub-category";
...
const category: NextPage = () => {
  ...
  const getData = () => {
    getSubCategory((data: any, error: any) => {
  ...
  const handelClickDelete = async (row: any) => {
    ...
    fetch(`${URL}/sub-category/delete/${row.id}`, requestOptions)
  ...
  const handelClickActive = async (row: any) => {
    ...
    fetch(`${URL}/sub-category/activate/${row.id}`, requestOptions)
      .then((response) => response.json())
      .then((result: any) => {
        message.success("The Item Delete was successfully");
        router.reload();
